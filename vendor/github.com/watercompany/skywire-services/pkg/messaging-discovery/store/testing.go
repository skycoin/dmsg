...
func (ms *MockStore) Entry(ctx context.Context, staticPubKey cipher.PubKey) (*client.Entry, error) {
...
func (ms *MockStore) SetEntry(ctx context.Context, entry *client.Entry) error {
...
func (ms *MockStore) AvailableServers(ctx context.Context, maxCount int) ([]*client.Entry, error) {

// Package commands cmd/dmsgpost/commands/dmsgpost.go
package commands
...
func init() {
	...
	RootCmd.PersistentFlags().BoolVarP(&helpflag, "help", "h", false, "help for dmsgpost")
	RootCmd.SetHelpCommand(&cobra.Command{Hidden: true})
	RootCmd.PersistentFlags().MarkHidden("help") //nolint
}

// RootCmd containsa the root dmsgpost command
